...
# coq_makefile CCNContentManagement.v CCNLine.v CCNProtocol.v CCNProtocolLemma.v CCNProtocolLemmaWithCM.v CCNProtocolOrthogonality.v CCNProtocolWithCM.v CCNSimpleNetwork.v CCNSimpleNetworkFIFO.v CCNSimpleNetworkFIFOMixed.v CCNSimpleNetworkLRU.v CCNTopology.v CCNTree.v CCNVerification.v CCNVerificationWithCM.v MiscSpec.v 
#
...
VFILES:=CCNContentManagement.v\
  CCNLine.v\
  CCNProtocol.v\
  CCNProtocolLemma.v\
  CCNProtocolLemmaWithCM.v\
  CCNProtocolOrthogonality.v\
  CCNProtocolWithCM.v\
  CCNSimpleNetwork.v\
  CCNSimpleNetworkFIFO.v\
  CCNSimpleNetworkFIFOMixed.v\
  CCNSimpleNetworkLRU.v\
  CCNTopology.v\
  CCNTree.v\
  CCNVerification.v\
  CCNVerificationWithCM.v\
  MiscSpec.v
...
.merlin:
	...
	@echo "B C:\Users\chiguri\Dropbox\Github\CCNprotocol" >> .merlin
	@echo "S C:\Users\chiguri\Dropbox\Github\CCNprotocol" >> .merlin
