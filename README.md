...
There are 10 main files and 4 examples.
...
* CCNSimpleNetworkFIFO.v : instance of content management function with CCNSimpleNetwork.v


## Build

Install Coq 8.4 pl6 (maybe any version of 8.4 can be used, but not 8.5) and use "make" command.
